...
const Products = () => {
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <button
                          ...
                          onClick={() => filterProductsByType('Gumy')}
                        >
                          Gumy
                        </button>
                      )}
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <button
                          ...
                          onClick={() => filterProductsByType('Twarde')}
                        >
                          Twarde
                        </button>
                      )}
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <button
                          ...
                          onClick={() => filterProductsByType('Zestawy')}
                        >
                          Zestawy
                        </button>
                      )}
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <button
                          ...
                          onClick={() => filterProductsByType('Akcesoria')}
                        >
                          Akcesoria
                        </button>
                      )}
  ...
  < div className="grid grid-cols-1 gap-x-10 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
